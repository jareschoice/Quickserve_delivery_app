    ...
    try {
      ...
      final fields = {
        ...
        if (_durationCtrl.text.trim().isNotEmpty)
          'prepDurationMins': _durationCtrl.text.trim(),
      };
      // Use JSON endpoint for now (multipart upload optional later)
      await _api.post('/api/products', fields);
      if (!mounted) return;
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                keyboardType: TextInputType.number,
                decoration: const InputDecoration(
                  labelText: 'Preparation + Delivery duration (mins)',
                ),
              ),
